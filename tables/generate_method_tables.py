...
def generate_pt_demo_table():
    ...
    f.write(vert_sp)
    f.write(f"Label{horiz_sp}n (%){vert_sp}")
    f.write(f"Surviving 6 Months{horiz_sp}" + get_label_balance("surv_mo_6", True))
    f.write(f"Surviving 36 Months{horiz_sp} " + get_label_balance("surv_mo_36", True))
    f.write(f"Surviving 60 Months{horiz_sp} " + get_label_balance("surv_mo_60", True))
    f.write(vert_sp)
