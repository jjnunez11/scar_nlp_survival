...
python -m models.bert --target "surv_mo_6" --batch-size 8 --table "survival_dif_lengths" --table_extra "6"
python -m models.bert --target "surv_mo_36" --batch-size 8 --table "survival_dif_lengths" --table_extra "36"
python -m models.bert --target "surv_mo_60" --batch-size 8 --table "survival_dif_lengths" --table_extra "60"
